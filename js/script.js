...
let box = 32;
let snake = []; //cria snake como lista, já que ela vai ser uma série de coordenadas, que quando pintadas, criam os quadrinhos
snake[0] = {
    x: 8 * box,
    y: 8 * box
}
...
function criarBG() {
    ...
    context.fillRect(0, 0, 16 * box, 16 * box); //desenha o rectangulo usando x e y e a largura e altura setadas
}
